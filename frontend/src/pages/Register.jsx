  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary-950 via-primary-900 to-primary-700 flex items-center justify-center p-4">
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-1/3 right-1/4 w-80 h-80 bg-primary-400/10 rounded-full blur-3xl" />
      </div>
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="text-center mb-8">
          ...
          <p className="text-primary-300 mt-1">Start tracking your expenses today</p>
        </div>
        ...
        <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 shadow-2xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="block text-sm font-medium text-primary-200 mb-1">Full Name</label>
              <input
                className="w-full bg-white/10 border border-white/20 rounded-xl px-4 py-2.5 text-white placeholder-primary-400 focus:outline-none focus:ring-2 focus:ring-primary-400 transition-all"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-white text-primary-900 font-bold py-3 rounded-xl hover:bg-primary-50 transition-all shadow-lg active:scale-95 disabled:opacity-50"
            >
